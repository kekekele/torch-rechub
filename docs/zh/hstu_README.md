...
下面从大规模样本表示、FiLM、双时间建模、`logQ`、课程式负样本难度调度和样本加权六个角度，说明当前实现为什么这样设计，以及它相对基础 HSTU 序列建模骨架额外增强了什么。
...
如果将基础 HSTU 看作“负责时序建模的主干骨架”，那么当前实现主要做了七类增强：
